...
This dataset is about portugal properties and project dataset was downloaded from  " https://www.kaggle.com/datasets/mcarujo/portugal-proprieties-rent-buy-and-vacation " .
We have Locations, Rooms , Price, Area, Bathrooms, Conditions, AdsType, PropertyType details in dataset .



# Overview

Welcome to the Portugal_ads_Properties project ! This analysis dives into a comprehensive dataset of Portugal properties sourced from Kaggle. The dataset has undergone through cleaning and addressing issues to ensure a robust foundation for exploration.

## SQL Exploration Highlights

1. **Ad Types and Pricing:**

2. **District-wise Room Pricing:**

3. **Area-based Pricing Analysis:**

4. **Room Numbers Distribution:**

5. **Rental Property Analysis:**

6. **Property Size Considerations:**
